...
export default function SignUp() {
  ...
  //Keeps track of email, password, and name onchange in form
  function onChange(e) {
  ...
  //Function for creating a user and submitting them to firebase
  async function onSubmit(e) {
    ...
    try {
      ...
      //Update user profile with their entered name
      ...
      // set Document in firebase store in "users" with a copy of the user data minus the password and then navigate back to home page
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg">
              ...
              <p>
                <Link
                  to="/forgot-password"
                  className="text-blue-600 hover:text-blue-800 ml-2 transition duration-200 ease-in-out"
                >
                  Forgot password?
                </Link>
              </p>
            ...
            duration-2000 ease-in-out hover:shadow-lg active:bg-blue-800"
              type="submit"
            >
              Sign up
            </button>
